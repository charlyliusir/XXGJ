...
- (UIImageView *)tickImageView {
    if (!_tickImageView) {
        ...
        tickImageView.image = [UIImage imageNamed:@"chat_photo_unselected_icon"];
...
- (void)setMaskViewFlag:(BOOL)maskViewFlag {
    ...
    if (!maskViewFlag) {
        // hidden
        [self.tickImageView setImage:[UIImage imageNamed:@"chat_photo_unselected_icon"]];
    }else{
        [self.tickImageView setImage:[UIImage imageNamed:@"chat_photo_selected_icon"]];
    }
